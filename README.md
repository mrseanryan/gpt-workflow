...
| ![images/dot_graph_7.png](images/dot_graph_7.png)|
|---|
| Iiterate over Job Applications in a list. For each Job Application, call another flow that checks if the application should proceed to interview stage. |
